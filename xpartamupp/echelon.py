...
class Leaderboard:
    ...
    def get_or_create_player(self, jid):
        ...
        Arguments:
            jid (JID): JID of the player to get
    ...
    def get_profile(self, jid):
        ...
        Arguments:
            jid (JID): JID of the player to retrieve the profile for
    ...
    def get_rating_list(self, nicks):
        ...
        ratings = {}
        if nicks:
            nicks = {JID(jid).bare + "/0ad": nick for jid, nick in nicks.items()}
